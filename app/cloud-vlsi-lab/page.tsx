...
export default function CloudLabRoute() {
    ...
    <div className={`min-h-screen ${darkMode ? 'bg-[#080E24] text-slate-100' : 'bg-slate-50 text-slate-900'}`}>
      ...
      <main className="pt-32 pb-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="text-center max-w-3xl mx-auto space-y-3">
          <span className="text-xs font-mono text-cyan-400 uppercase tracking-widest">Silphor Cloud Infrastructure</span>
          <h1 className="text-3xl sm:text-4xl font-extrabold">Cloud VLSI Lab & Simulator</h1>
          <p className="text-slate-300 text-sm">Write, compile, and simulate Verilog & SystemVerilog IP directly in your browser.</p>
        </div>
